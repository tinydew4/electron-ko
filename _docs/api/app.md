...
[browserWindow](http://electron.atom.io/docs/api/browser-window)에 대한 포커스가 사라졌을 때 발생하는 이벤트입니다.
...
[browserWindow](http://electron.atom.io/docs/api/browser-window)에 대한 포커스가 발생했을 때 발생하는 이벤트입니다.
...
새로운 [browserWindow](http://electron.atom.io/docs/api/browser-window)가 생성되었을 때 발생하는 이벤트입니다.
...
새로운 [webContents](http://electron.atom.io/docs/api/web-contents)가 생성되었을 때 발생하는 이벤트입니다.
...
반환합니다. 반환될 수 있는 값은 [여기](http://electron.atom.io/docs/api/locales)에서 찾아볼 수 있습니다.
