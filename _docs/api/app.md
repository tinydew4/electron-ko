...
redirect_from:
    ...
    - /docs-translations/ko-KR/api/app/
    - /docs-translations/ko-KR/api/app/
source_url: 'https://github.com/electron/electron/blob/master/docs-translations/ko-KR/api/app.md'
excerpt: "&#xC560;&#xD50C;&#xB9AC;&#xCF00;&#xC774;&#xC158;&#xC758; &#xC774;&#xBCA4;&#xD2B8; &#xC0DD;&#xBA85;&#xC8FC;&#xAE30;&#xB97C; &#xC81C;&#xC5B4;&#xD569;&#xB2C8;&#xB2E4;."
title: "app"
sort_title: "app"
---
...
[browserWindow](http://tinydew4.github.io/electron-ko/docs/api/browser-window)에 대한 포커스가 사라졌을 때 발생하는 이벤트입니다.
...
[browserWindow](http://tinydew4.github.io/electron-ko/docs/api/browser-window)에 대한 포커스가 발생했을 때 발생하는 이벤트입니다.
...
새로운 [browserWindow](http://tinydew4.github.io/electron-ko/docs/api/browser-window)가 생성되었을 때 발생하는 이벤트입니다.
...
새로운 [webContents](http://tinydew4.github.io/electron-ko/docs/api/web-contents)가 생성되었을 때 발생하는 이벤트입니다.
...
있는 값은 [여기](http://tinydew4.github.io/electron-ko/docs/api/locales)에서 찾아볼 수 있습니다.
...
있습니다. 이는 런타임에서 변경될 수 없습니다. 이 파일은 간단히 텍스트 ���디터를
...
**참고:** 이 API 는 docs/tutorial/mac-app-store-submission-guide
에 영향을 주지 않습니다.
...
* `menu` [Menu](http://tinydew4.github.io/electron-ko/docs/api/menu)
...
[unity-requiremnt]: http://tinydew4.github.io/electron-ko/docs/tutorial/desktop-environment-integration#unity-launcher-shortcuts-linux
