...
[`BrowserWindow`](http://tinydew4.github.io/electron-ko/docs/api/browser-window)의 속성입니다. 다음은 `webContents` 객체에
접근하는 예시입니다:
...
사용법은 [`app`의 `certificate-error` 이벤트](http://tinydew4.github.io/electron-ko/docs/api/app#event-certificate-error)와
같습니다.
...
사용법은 [`app`의 `select-client-certificate` 이벤트](http://tinydew4.github.io/electron-ko/docs/api/app#event-select-client-certificate)와
같습니다.
...
[`app`의 `login`이벤트](http://tinydew4.github.io/electron-ko/docs/api/app#event-login)와 사용 방법은 같습니다.
...
* `image` [NativeImage](http://tinydew4.github.io/electron-ko/docs/api/native-image) - 전체 프레임의 이미지 데이터.
...
[`found-in-page`](http://tinydew4.github.io/electron-ko/docs/api/web-contents#event-found-in-page) 이벤트를 통해 취득할 수
있습니다.
...
`callback(image)` 형식으로 호출됩니다. `image`는 [NativeImage](http://tinydew4.github.io/electron-ko/docs/api/native-image)의
...
* `keyCode` String (**required**) - 키보드 이벤트가 발생할 때 보내질 문자.
  [Accelerator](http://tinydew4.github.io/electron-ko/docs/api/accelerator)의 올바른 키 코드만 사용해야 합니다.
...
이 webContents에서 사용하는 [session](http://tinydew4.github.io/electron-ko/docs/api/session) 객체를 반환합니다.
